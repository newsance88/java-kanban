public class Main {
    public static void main(String[] args) {
        ...
        taskManager.addSub(new Sub("Саб1", Status.DONE, epic.getId()));
        taskManager.addSub(new Sub("Саб2", Status.DONE, epic.getId()));
        taskManager.addSub(new Sub("Саб3", Status.DONE, epic.getId()));
        taskManager.addSub(new Sub("Саб4", Status.DONE, epic.getId()));
